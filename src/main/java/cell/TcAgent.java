    ...
    private static class QTransformer implements ClassFileTransformer {
        ...
        public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws IllegalClassFormatException {
            ...
            try {
                ...
                CtMethod isPerUsageMode = cc.getDeclaredMethod("isPerUsageMode");
                isPerUsageMode.setBody("{ return false; }");
                ...
                CtMethod getNumberOfPredefinedBuildTypes = cc.getDeclaredMethod("getNumberOfPredefinedBuildTypes");
                getNumberOfPredefinedBuildTypes.setBody("{ return 9999; }");
